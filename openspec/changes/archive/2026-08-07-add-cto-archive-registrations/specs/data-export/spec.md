...
#### Scenario: Archived registrations excluded from export
- **WHEN** one or more registrations are archived
- **THEN** neither export path (in-admin button or CLI) includes them, regardless of who triggers the export
