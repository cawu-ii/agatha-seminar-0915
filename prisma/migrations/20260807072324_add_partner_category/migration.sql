...
INSERT INTO "new_Partner" ("createdAt", "description", "id", "logoUrl", "name", "sortOrder", "updatedAt") SELECT "createdAt", "description", "id", "logoUrl", "name", "sortOrder", "updatedAt" FROM "Partner";
DROP TABLE "Partner";
